// Particles Stars Js (Infinte Direction Motion) : sketch.infinite.js
// Id Attr: "particles-stars"
/* -----------------------------------------------
/* How to use? : HTML
    Add: <canvas id="particles-stars"></canvas>
/* ----------------------------------------------- */
...
function Star() {
    ...
    this.show = function() {
        ...
        starsCtx.beginPath();
        starsCtx.fillStyle = "rgba(0, 0, 0, " + opacity + ")";
